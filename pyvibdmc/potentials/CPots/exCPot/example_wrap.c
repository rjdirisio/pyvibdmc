...
SWIGINTERN PyObject *_wrap_harmonic_oscillator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  float arg1 ;
  float val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:harmonic_oscillator",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_float(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "harmonic_oscillator" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = (float)(val1);
  result = (double)harmonic_oscillator(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"harmonic_oscillator", _wrap_harmonic_oscillator, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
